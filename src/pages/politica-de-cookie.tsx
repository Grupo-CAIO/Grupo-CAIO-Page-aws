...
const CookiePoliticy = () => {
	const isMobile = useWindowDimensions();
	const {scrollYProgress} = useScroll();
	const scaleX = scale(scrollYProgress);

	const content = `<h1 style='font-size:40px; color:#ffffff; padding: 10px 0 20px;line-height:40px;'>Política de Cookie</h1>
	...
	return (
		<main className='caio_main_container'>
			<Header isMobile={isMobile} isLanding={true} />
...
export default CookiePoliticy;

export const Head: HeadFC = () => <title>Política de Cookie | Partner - VTEX</title>;
