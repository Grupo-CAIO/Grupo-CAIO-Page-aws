...
const PrivacityPoliticy = () => {
	const isMobile = useWindowDimensions();
	const {scrollYProgress} = useScroll();
	const scaleX = scale(scrollYProgress);

	const content = `<h1 style='font-size:40px; color:#ffffff; padding: 10px 0 20px;line-height:40px;'>Política de Privacidad</h1>
...
export default PrivacityPoliticy;

export const Head: HeadFC = () => <title>Política de Privacidad | Partner - VTEX</title>;
