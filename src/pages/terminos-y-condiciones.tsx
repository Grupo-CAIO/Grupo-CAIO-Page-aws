...
const TermsAndConditions = () => {
	...
	const content = `<h1 style='font-size:40px; color:#ffffff; padding: 10px 0 20px;line-height:40px;'>Términos y Condiciones</h1>
...
export const Head: HeadFC = () => <title>Términos y Condiciones | Partner - VTEX</title>;
